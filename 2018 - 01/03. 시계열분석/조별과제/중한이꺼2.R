...
fit11 <- Arima(log_airport,order=c(2,0,3),fixed=c(NA,NA,0,NA,NA,NA),seasonal = list(order=c(0,1,1),period=12))
...
confint(Arima(log_airport,order=c(3,0,4),fixed=c(NA,NA,NA,0,NA,NA,NA,NA),seasonal = list(order=c(0,1,1),period=12)))  #X
...
c(fit2.1.2.2$aic,fit2.1.2.2$bic)
...
plot(fore_arima,xlim=c(2017,2018),ylim=c(3000000,8000000))
lines(new_t,port17,col="red")
accuracy(forecast(fit1),port17)   #211 011